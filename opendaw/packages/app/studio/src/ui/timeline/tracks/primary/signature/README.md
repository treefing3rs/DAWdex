...
The `relative-position` field defines how many bars this signature lasts. The absolute position is computed by
accumulating the relative positions of all preceding events.
