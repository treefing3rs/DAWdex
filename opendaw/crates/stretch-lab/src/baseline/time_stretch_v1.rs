// FROZEN BASELINE — verbatim copy of engine/src/time_stretch.rs @ 499aa632. Never edit.
// Mechanical changes only: pub(crate) -> pub (the engine crate is a cdylib and cannot be a
// dependency; this copy is the yardstick every improvement is measured against).
...
pub struct TimeStretchSequencer {
    voices: Vec<Voice>,
    spawn: Vec<Voice>,
